...
class LeftBannerController
{
    public function index()
    {
        // Fetch all banners from database
        $pdo = require_once __DIR__ . '/../../config/database.php';
        $stmt = $pdo->query('SELECT * FROM banners WHERE type="left_banner"');
        $banners = $stmt->fetchAll();

        // Render view to display banners
        require_once __DIR__ . '/../Views/admin/LeftBanner/index.php';
    }

    public function create()
    {
        // Render view to create new banner
        require_once __DIR__ . '/../Views/admin/LeftBanner/create.php';
    }
    ...
    public function store()
    {
        ...
        $link = $_POST['link'] ?? '';
        $type = $_POST['type'] ?? '';
        $uploadDir = __DIR__ . '/../../public/uploads/banners/left/';
        if (!is_dir($uploadDir)) {
        ...
        if (isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
            $image_path = 'uploads/banners/left/' . basename($_FILES['image']['name']);
        ...
        header('Location: admin/left_banner/manage');
        exit;
    }
    ...
    public function edit()
    {
        ...
        require_once __DIR__ . '/../Views/admin/LeftBanner/edit.php';
    }
