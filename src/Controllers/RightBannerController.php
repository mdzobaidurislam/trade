...
class RightBannerController
{
    public function index()
    {
        ...
        $stmt = $pdo->query('SELECT * FROM banners WHERE type="right_banner"');
        $banners = $stmt->fetchAll();

        // Render view to display banners
        require_once __DIR__ . '/../Views/admin/RightBanner/index.php';
    }

    public function create()
    {
        // Render view to create new banner
        require_once __DIR__ . '/../Views/admin/RightBanner/create.php';
    }
    ...
    public function store()
    {
        ...
        $link = $_POST['link'] ?? '';
        $type = $_POST['type'] ?? '';
        $uploadDir = __DIR__ . '/../../public/uploads/banners/right/';
        if (!is_dir($uploadDir)) {
        ...
        if (isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
            $image_path = 'uploads/banners/right/' . basename($_FILES['image']['name']);
        ...
        header('Location: admin/right_banner/manage');
        exit;
    }
    ...
    public function edit()
    {
        ...
        require_once __DIR__ . '/../Views/admin/RightBanner/edit.php';
    }
