    ...
    <div class="row">
        <div class="col-lg-12 mt-3 mb-3">
            <div class="trade_wrap">
                ...
                <a href="trade_search?nobayon=nobayon" class="trade_btn">ট্রেড লাইসেন্স নবায়ন </a>
            </div>
        </div>
        <div class="col-lg-12">
            <div class="trade_wrap">
                <a href="trade_search" class="trade_btn">ট্রেড লাইসেন্স সংশোধন </a>
            </div>
            <div class="trade_wrap">
                <a href="trade_search" class="trade_btn"> সকল পিডিএফ </a>
            </div>
        </div>
    </div>
</div>
