...
<head>
    ...
    <style>
        ...
        @media print {
            ...
            .ward_no {
                position: absolute;
                top: <?php echo $lang ? '246px' : '8.8cm' ?>;
                left: <?php echo $lang ? '138px' : '5.25cm' ?>;
                font-size: 14px;
            }

            .issue_date {
                padding-top: <?php echo $lang ? '267px' : '9.4cm' ?>;
                padding-left: <?php echo $lang ? '168px' : '5.25cm' ?>;
                font-size: 14px;
            }

            .trade_license_type {
                position: absolute;
                top: <?php echo $lang ? '285px' : '10cm' ?>;
                left: <?php echo $lang ? '207px' : '5.94cm' ?>;
                font-size: 14px;
            }
