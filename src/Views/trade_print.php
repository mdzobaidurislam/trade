...
<head>
    ...
    <style>
        ...
        @media print {
            ...
            .ward_no {
                position: absolute;
                top: <?php echo $lang ? '246px' : '9.3cm' ?>;
                left: <?php echo $lang ? '138px' : '5.28cm' ?>;
                font-size: 14px;
            }

            .issue_date {
                padding-top: <?php echo $lang ? '267px' : '10.06cm' ?>;
                padding-left: <?php echo $lang ? '168px' : '5.28cm' ?>;
                font-size: 14px;
            }

            .trade_license_type {
                position: absolute;
                top: <?php echo $lang ? '285px' : '10.6cm' ?>;
                left: <?php echo $lang ? '207px' : '6.1cm' ?>;
                font-size: 14px;
            }

            .trade_license_number {
                position: absolute;
                top: <?php echo $lang ? '301px' : '10.88cm' ?>;
                left: 14.81cm;
                font-size: 14px;
            }
