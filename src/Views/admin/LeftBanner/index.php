...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mt-3 mb-3">
        <h3>Manage Logo</h3>
        <a href="admin/left_banner/create" class="btn btn-primary">Add New logo</a>
    </div>
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex gap-2">
                        <a href="admin/left_banner/edit?id=<?php echo htmlspecialchars($banner['id']); ?>"
                            class="btn btn-sm btn-warning">Edit</a>
                        <form method="post" action="left_banner_delete">
