...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mt-3 mb-3">
        ...
        <a href="admin/banner/create" class="btn btn-primary">Add New Banner</a>
    </div>
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex gap-2">
                        <a href="admin/banner/edit?id=<?php echo htmlspecialchars($banner['id']); ?>"
                            class="btn btn-sm btn-warning">Edit</a>
                        <form method="post" action="banner_delete">
